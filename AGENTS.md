# AGENTS.md - AI Personal Assistant Project Hub

> **DO NOT MODIFY THIS FILE UNLESS EXPLICITLY ASKED TO BY THE USER.**
> This document serves as the central reference for ALL AI agents (any model) working on this project.
...
2. **Track Progress**: Document what you're working on and progress made
3. **Small Steps**: Break large tasks into testable increments
4. **Commit Often**: Save working states frequently
5. **Ask When Unclear**: Request clarification when requirements are ambiguous
...
4. Reference your notes to resume work
...
- Follow the notes naming convention (see Section 9)
...
1. **Creating Notes**
   ...
   - Example: `GPT4_20250118_api-design-decisions.md`
...
2. **Note Content**
   ...
   **Agent**: [Your identifier - Claude, GPT-4, Llama, etc.]
...
```
/
├── CLAUDE.md           # Project hub for Claude agents
├── AGENTS.md           # This file - model-agnostic project hub
